  ...
  return (
    <main className="flex flex-col md:px-24 md:w-3/5 w-full md:mx-auto px-5 mt-10">
      ...
      <p className="pt-5 pb-10">
        I'm currently a student at the University of California, Irvine, and I'm
        pursuing a B.S. in Computer Science. I'm also a part of the Association
        for Computing Machinery (ACM) at UCI, and I'm a part of the Web
        Development team.
      </p>
      <h1 className="text-3xl font-bold pb-5">Videogames</h1>
      <p>
        I deeply enjoy playing videogames, and I've been playing them since I
        was a kid. Recently I've been playing a lot of Valorant and League of
        Legends recently.
      </p>
    </main>
  );
